  ...
  <model name="wall_@(wall.count)">
    ...
    <link name="link">
      ...
      <visual name='visual'>
        ...
        <material><script><name>Gazebo/PaintedWall</name></script></material>
      </visual>
    </link>
  </model>
@[end def]
@{wall.count = 0}
@( wall((-1.75, -1.75), ( 6.00 , -1.75), 1.0) )
@( wall((-1.75, -1.75), (-1.75,   1.75), 1.0) )
@( wall((-1.75,  1.75), ( 6.00,   1.75), 1.0) )
@( wall(( 3.00,  0.75), ( 3.00,   1.75), 1.0) )
@( wall(( 3.00, -0.75), ( 3.00,  -1.75), 1.0) )
@( wall(( 6.00, -1.75), ( 6.00,  -1.00), 1.0) )
@( wall(( 6.00,  0.00), ( 6.00,   1.75), 1.0) )
